    ...
    <TooltipProvider>
      <div className="flex flex-col items-center justify-center min-h-screen py-8 min-[720px]:py-0">
        <div className="w-full max-w-6xl flex flex-col gap-6 px-4">
          <div className="relative flex flex-col gap-8 min-[720px]:flex-row min-[720px]:gap-0 min-[720px]:items-stretch min-[720px]:shadow-[8px_8px_30px_rgba(0,0,0,0.6)] min-[720px]:rounded-xl">
